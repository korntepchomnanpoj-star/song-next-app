...
export default function HerbForm({ addTask, editingTask, updateTask, resetEditingTask }){
    ...
    const handelSubmit = (e) => {
        ...
        if(editingTask)
          updateTask(editingTask.id, title, taskStatus, desc, suppiler);
        else
        addTask(title, taskStatus, desc, suppiler);
