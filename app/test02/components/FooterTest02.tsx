export default function FooterTest02() {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li><a href="#" className="text-slate-400 hover:text-white transition">Xxx</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition">Xxx</a></li>
              <li><a href="#" className="text-slate-400 hover:text-white transition">Xxx</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form className="mt-4 flex max-w-md gap-2">
              <input type="email" required className="w-full rounded-md border-0 bg-slate-700 px-4 py-2 text-sm text-white shadow-sm ring-1 ring-slate-600 focus:ring-2 focus:ring-blue-500" placeholder="Enter your email" />
